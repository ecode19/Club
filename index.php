    ...
    <div class="content shadow-lg d-lg-none" id="Home">
        <div class="row">
            ...
            <div class="text-center mt-3 py-5">
                <a href="login.php"><button class="btn btn23 btn-lg px-lg-5 text-white fs-3" data-aos="fade-right"
                        data-aos-duration="2000">Login</button></a>
                <a href="register.php"><button class="btn btn23 btn-lg px-lg-5 text-white fs-3 mx-lg-3"
    ...
    <section class="d-lg-block d-none">
        <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
                ...
                <div class="carousel-item">
                    <img src="img/uni.jpg" class="d-block w-100 h-100" alt="...">
                    <div class="carousel-caption d-none d-md-block">
        ...
        <div class="container">
            <div class="row bg-light text-dark g-2 justify-content-center">
                <div class="col-12 col-md-10 col-lg-8 text-center">
                    ...
                    <p align="justify" class="p1 lead" style="letter-spacing: 1px; font-size: 20; line-height: 30px;">
                ...
                <div class="col-md-10 col-lg-4 text-center py-5">
                    <a href="#" class="navbar-brand text-primary"><img class="img-fluid w-50 h-70 rounded-circle "
                            src="img/logo.jpg"></a>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md">
                    ...
                    <p align="justify" class="text-justify lh-lg">It is an essential aspect of the modern digital world
                        and has
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="card card-bottom-border text-dark">
                        <div class="card-body text-center">
                            ...
                            <p class="text-justify">Members could learn about cybersecurity and work on projects related
                                to protecting
                                computer systems from threats.</p>
                        </div>
                    </div>
                    <a class=" btn btn-sm mt-3 text-dark" href="services.html" style="background-color: #19c357;">More
        ...
        <div class="container">
            <div class="row">
                <div class="col-md text-light fs-1">
                    <div class="mb-4">
                        <h1 class="mb-3 d-none" data-aos="fade-up" data-aos-duration="1000">Membership categories</h1>
                ...
                <div class="text-center">
                    <a href="register.html"><button class="btn btn-lg fs-3 text-white fw-bold" data-aos="zoom-out"
                            style="background-color: #19c357;">JOIN
                            US NOW</button></a>
                </div>
            </div>
        </div>
                    ...
                    <div id="card-container" class="card-body border-news"
                        ...
                        <div class="card">
                            ...
                            <div class="card-footer">
                                <a href="./events/website.html" target="_blank" class="btn news-btn text-white">Read
                                    More</a>
                            </div>
                        </div>
                        <div class="card ">
                        ...
                        <div class="card d-none">
                            ...
                            <div class="card-footer">
                                <a href="#" target="_blank" class="btn colorIcon news-btn text-white">Read More</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <section class="mt-md-5 mt-lg-2 mb-4 align-items-center">
        <div class="container">
            <div class="row g-2">
                ...
                <div class="col-lg-3 col-md-3 col-3 d-flex justify-content-center" data-aos="flip-up"
                    data-aos-duration="1000">
                    <img src="img/misitu2.png" alt="SVG image" class="img-fluid rounded-circle" style="width: 150px;">
                </div>
                <div class="col-lg-3 col-md-3 col-3 d-flex justify-content-center" data-aos="flip-up"
                    data-aos-duration="1000">
