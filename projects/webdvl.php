    ...
    <div class="container-fluid" id="webdvl">
      <div class="row text-center">
        <div class="departments">
          <center><h4 class="text-warning display-4 mt-5 font-family-monospace">WEB DEVELOPMENT</h4></center>
        </div>
      </div>
      <div class="container">
    <div class="row">
      <div class="">
        ...
        <span class="text-primary fs-4">Web development.</span> refers to the process of building websites and applications for the internet. It involves several disciplines, including front-end development (designing and coding the user interface), back-end development (building and maintaining the server-side of web applications), and full-stack development (combining front-end and back-end skills).
    </p>
  </div>
    </div>
  </div>
      <div class="container col-lg-10 col-sm-12 col-md-12">
        <center><button class="btn btn-brand btn-lg"><a class="text-warning nav-item nav-link" href="#">Scroll Down <i class="fas fa-arrow-down fs-2 stricky-top"></i></a></button></center>
      </div>
    </div>
  </section>
  <section  style="background-color: rgb(5, 5, 39);">
    <div class="container">
      <div class="row g-3 fs-5">
        <h4 class="text-center fs-3 pt-4 text-uppercase text-warning">Possible Guideline for Web development topic</h4>
      ...
      <a href="register.html" class="icon text-decoration-none text-warning text-lg-start ms-5 fs-4">Register now as member</a>
    </div>
  </section>
  <div class="container">
    <p class="text-dark text-lg-start">Copyright <i class="far fa-copyright text-danger"></i> 2023 Ecode Technologies</p>
  </div>
  <!--Bootstrap CDN link-->
