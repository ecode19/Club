...
<body class="text-light text-capitalize">
    ...
    <div class="container-fluid" id="maintenance">
      <div class="row text-center">
        <div class="departments">
          <center><h4 class="text-warning display-4 mt-5 font-family-monospace">COMPUTER MAINTENANCE</h4></center>
        </div>
      </div>
      <div class="container">
    <div class="row">
      <div class="">
        ...
        <span class="text-primary fs-4">Computer maintenance.</span> involves the regular upkeep of computer systems to ensure they are running efficiently and effectively. It includes tasks such as updating software, cleaning hardware components, and performing regular backups of important data. In the ICT Club Computer Maintenance program, members will learn how to diagnose and troubleshoot computer problems, perform hardware and software upgrades, and maintain the health and performance of computer systems. The program will also cover topics such as virus and malware protection, data recovery, and system optimization to ensure that members have the knowledge and skills necessary to keep their computers running smoothly.
    </p>
  </div>
    </div>
  </div>
  ...
  <div class="container">
          <p class="lead text-center text-dark">Copyright &copy; 2023 Ecode Technologies</p>
        </div>
      <!--
      <div class="container">
